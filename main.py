...
class Board:
    ...
    def on_click(self, cell_row: int, cell_col: int) -> None:
        for col in range(self.width):
            self.board[cell_row][col] = opposite_cell(self.board[cell_row][col])
        for row in range(self.height):
            self.board[row][cell_col] = opposite_cell(self.board[row][cell_col])

        self.board[cell_row][cell_col] = opposite_cell(self.board[cell_row][cell_col])
